        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Have questions about Agent OTP? We&apos;re here to help.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="rounded-2xl border border-border p-8">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <a
                      href="mailto:hello@agentotp.com"
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:support@agentotp.com"
                      className="text-primary hover:underline"
                    >
                      support@agentotp.com
                    </a>
                  </div>
                  <div>
                    <h3 className="font-medium mb-1">Sales</h3>
                    <a
                      href="mailto:sales@agentotp.com"
                      className="text-primary hover:underline"
                    >
                      sales@agentotp.com
                    </a>
              ...
              <div className="rounded-2xl border border-border p-8">
                ...
                <div className="space-y-4">
                  ...
                  <a
                    href="https://twitter.com/agentotp"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 text-muted-foreground hover:text-foreground transition-colors"
                  >
              ...
              <div className="rounded-2xl border border-border p-8 bg-muted/30">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Check out our documentation and FAQ for quick answers to
                  common questions.
                </p>
